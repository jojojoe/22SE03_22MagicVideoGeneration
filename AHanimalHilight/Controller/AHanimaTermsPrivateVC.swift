//
//  AHanimaTermsPrivateVC.swift
//  AHanimalHilight
//
//  Created by JOJO on 2022/9/9.
//

import UIKit

class AHanimaTermsPrivateVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(hexString: "#072142")
        ...
        contentTextView.textColor = .white.withAlphaComponent(0.5)
        contentTextView.font = UIFont(name: "Avenir-Medium", size: 14)
        view.addSubview(contentTextView)
        contentTextView.snp.makeConstraints {
            $0.top.equalTo(bottomBanner.snp.bottom).offset(20)
            $0.left.equalTo(20)
            $0.right.equalTo(-20)
...
Application means the software program provided by the Company downloaded by You on any electronic device, named ReBoBo

Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ReBoBo.
...
By email: se701303@gmail.com
Generated using Privacy Policies Generator
"""

let termsStr_Info =
"""
Terms and Conditions for ReBoBo
